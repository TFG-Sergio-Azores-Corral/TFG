...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	public EList<UMLElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<UMLElement>(UMLElement.class, this, UsecasePackage.MODEL__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<Relation> getRelations() {
		if (relations == null) {
			relations = new EObjectContainmentEList<Relation>(Relation.class, this, UsecasePackage.MODEL__RELATIONS);
		}
		return relations;
	}
