...
import org.usecase.usecase.Extend;
import org.usecase.usecase.Generalization;
import org.usecase.usecase.Include;
...
public class UsecasePackageImpl extends EPackageImpl implements UsecasePackage {
	 ...
	 * @see org.usecase.usecase.UsecasePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		actorEClass.getESuperTypes().add(this.getUMLElement());
		useCaseEClass.getESuperTypes().add(this.getUMLElement());
		associationEClass.getESuperTypes().add(this.getRelation());
		generalizationEClass.getESuperTypes().add(this.getRelation());
		extendEClass.getESuperTypes().add(this.getRelation());
		includeEClass.getESuperTypes().add(this.getRelation());

		// Initialize classes, features, and operations; add parameters
		initEClass(modelEClass, Model.class, "Model", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModel_Elements(), this.getUMLElement(), null, "elements", null, 0, -1, Model.class,
		...
		initEAttribute(getUMLElement_Name(), ecorePackage.getEString(), "name", null, 1, 1, UMLElement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(relationEClass, Relation.class, "Relation", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelation_Source(), this.getUMLElement(), null, "source", null, 1, 1, Relation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelation_Target(), this.getUMLElement(), null, "target", null, 1, 1, Relation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
