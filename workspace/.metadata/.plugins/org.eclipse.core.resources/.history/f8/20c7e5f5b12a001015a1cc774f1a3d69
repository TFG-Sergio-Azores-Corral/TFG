...
public class UsecaseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case UsecasePackage.UML_ELEMENT: {
		...
		case UsecasePackage.ASSOCIATION: {
			...
			if (result == null)
				result = caseRelation(association);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UsecasePackage.GENERALIZATION: {
			...
			if (result == null)
				result = caseRelation(generalization);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
