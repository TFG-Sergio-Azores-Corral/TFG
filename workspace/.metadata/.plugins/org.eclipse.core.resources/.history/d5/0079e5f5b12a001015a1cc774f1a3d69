 ...
 * </p>
 * <ul>
 *   <li>{@link org.usecase.usecase.impl.UMLElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UMLElementImpl extends MinimalEObjectImpl.Container implements UMLElement {
	...
	protected EClass eStaticClass() {
		return UsecasePackage.Literals.UML_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsecasePackage.UML_ELEMENT__NAME, oldName, name));
	}
